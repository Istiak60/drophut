                ...
                <div class="user-actions">
                    <h3>
                        ...
                        <a class="Returning" href="#" data-toggle="collapse" data-target="#checkout_coupon"
                            aria-expanded="true" aria-controls="checkout_coupon">Click here to enter your code</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-20 accordion" id="accordionExample">
                                ...
                                <label class="righ_0" for="address" data-toggle="collapse"
                                    data-target="#collapseTwo" aria-controls="collapseTwo">Ship to a different
                                    address?</label>
                        ...
                        <div class="payment_method">
                            ...
                            <div class="panel-default">
                                ...
                                <label for="payment_defult" data-toggle="collapse" data-target="#collapseFour"
                                    aria-controls="collapseFour">PayPal <img src="asset/frontend/assets/img/icon/papyel.png"
                                        alt=""></label>
